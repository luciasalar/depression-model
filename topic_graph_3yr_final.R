...
###Warning: please run topic_graph_1year_final before this script
...
happy.3yr.plot= ggplot(data = indi_senti, aes(x = -day)) + 
...
#-0.1412279 ##p-value = 2.712e-06
cor.test(indi_senti$happy[indi_senti$symptom_group==1], -indi_senti$day[indi_senti$symptom_group==1])
#0.01298825   p-value = 0.6681

##truncate
t.test(indi_senti$happy[indi_senti$symptom_group==0][1:365],indi_senti$happy[indi_senti$symptom_group==1][1:365], var.equal=F, paired=FALSE)
#t = 0.032786, df = 545.59, p-value = 0.9739
t.test(indi_senti$happy[indi_senti$symptom_group==0][366:721],indi_senti$happy[indi_senti$symptom_group==1][366:721], var.equal=F, paired=FALSE)
#t = -0.84198, df = 457.74, p-value = 0.4002
t.test(indi_senti$happy[indi_senti$symptom_group==0][722:1095],indi_senti$happy[indi_senti$symptom_group==1][722:1095], var.equal=F, paired=FALSE)
#t = 3.0679, df = 517.52, p-value = 0.002268
...
negative.3yr.plot= ggplot(data = indi_senti, aes(x = -day)) + 
...
#t = -0.043656, df = 1470.9, p-value = 0.9652
#alternative hypothesis: true difference in means is not equal to 0

cor.test(indi_senti$negative[indi_senti$symptom_group==0], -indi_senti$day[indi_senti$symptom_group==0])
#low 0.07297972 ##p-value = p-value = 0.01572
cor.test(indi_senti$negative[indi_senti$symptom_group==1], -indi_senti$day[indi_senti$symptom_group==1])
#high 0.03133022  p-value = 0.301

####truncate
t.test(indi_senti$negative[indi_senti$symptom_group==0][1:365],indi_senti$negative[indi_senti$symptom_group==1][1:365], var.equal=F, paired=FALSE)
#t = -1.1881, df = 513.09, p-value = 0.2353
t.test(indi_senti$negative[indi_senti$symptom_group==0][366:721],indi_senti$negative[indi_senti$symptom_group==1][366:721], var.equal=F, paired=FALSE)
#t = 1.9519, df = 508.85, p-value = 0.0515
t.test(indi_senti$negative[indi_senti$symptom_group==0][722:1095],indi_senti$negative[indi_senti$symptom_group==1][722:1095], var.equal=F, paired=FALSE)
#t = -0.93587, df = 472.33, p-value = 0.3498

###recent 120days shows differences
t.test(indi_senti$negative[indi_senti$symptom_group==0][1:120],indi_senti$negative[indi_senti$symptom_group==1][1:120], var.equal=F, paired=FALSE)
#t = -2.3385, df = 193.8, p-value = 0.02038
...
#t = 2.2517, df = 1503.4, p-value = 0.02448
#alternative hypothesis: true difference in means is not equal to 0
...
#low 0.004684516  ##p-value =  p-value = 0.8769
cor.test(indi_senti$family[indi_senti$symptom_group==1], -indi_senti$day[indi_senti$symptom_group==1])
#high 0.01902042   p-value = 0.5301


t.test(indi_senti$family[indi_senti$symptom_group==0][1:365],indi_senti$family[indi_senti$symptom_group==1][1:365], var.equal=F, paired=FALSE)
#t = 1.6367, df = 513.17, p-value = 0.1023
t.test(indi_senti$family[indi_senti$symptom_group==0][366:721],indi_senti$family[indi_senti$symptom_group==1][366:721], var.equal=F, paired=FALSE)
#t = 0.95277, df = 462.26, p-value = 0.3412
t.test(indi_senti$family[indi_senti$symptom_group==0][722:1095],indi_senti$family[indi_senti$symptom_group==1][722:1095], var.equal=F, paired=FALSE)
#t = 1.4801, df = 525.61, p-value = 0.1394

t.test(indi_senti$family[indi_senti$symptom_group==0][1:100],indi_senti$family[indi_senti$symptom_group==1][1:100], var.equal=F, paired=FALSE)
#t = 1.9777, df = 163.96, p-value = 0.04963
...
somatic.3yr.plot= ggplot(data = indi_senti, aes(x = -day)) + 
...
#t = -2.3074, df = 1396.7, p-value = 0.02118
#alternative hypothesis: true difference in means is not equal to 0
...
#low -0.02001782   ##p-value =  p-value = 0.5082
cor.test(indi_senti$somatic[indi_senti$symptom_group==1], -indi_senti$day[indi_senti$symptom_group==1])
#high -0.01260203   p-value = 0.6774

t.test(indi_senti$somatic[indi_senti$symptom_group==0][1:365],indi_senti$somatic[indi_senti$symptom_group==1][1:365], var.equal=F, paired=FALSE)
#t = -1.4644, df = 483.4, p-value = 0.1437                                                                                                       t = -1.4644, df = 483.4, p-value = 0.1437
t.test(indi_senti$somatic[indi_senti$symptom_group==0][366:721],indi_senti$somatic[indi_senti$symptom_group==1][366:721], var.equal=F, paired=FALSE)
#t = -1.4165, df = 454.23, p-value = 0.1573
t.test(indi_senti$somatic[indi_senti$symptom_group==0][722:1095],indi_senti$somatic[indi_senti$symptom_group==1][722:1095], var.equal=F, paired=FALSE)
#t = -1.2804, df = 468.37, p-value = 0.201

#t.test(indi_senti$somatic[indi_senti$symptom_group==0][1:150],indi_senti$somatic[indi_senti$symptom_group==1][1:150], var.equal=F, paired=FALSE)
...
self.3yr.plot= ggplot(data = indi_senti, aes(x = -day)) + 
...
them.3yr.plot= ggplot(data = indi_senti, aes(x = -day)) + 
...
multiplot(somatic.plot,family.plot,self.plot,them.plot,somatic.3yr.plot,family.3yr.plot,self.3yr.plot,them.3yr.plot, cols = 2)
...
sentiment.3yr.plot = ggplot(data = all_count, aes(x = -day)) + 
...
multiplot(sentiment.plot,sentiment.3yr.plot)
...
t.test(all_count$day.aver_l[366:720],all_count$day.aver_h[366:720], var.equal=F, paired=FALSE)
#t = 0.98333, df = 478.9, p-value = 0.3259
t.test(all_count$day.aver_l[721:1095],all_count$day.aver_h[721:1095], var.equal=F, paired=FALSE)
#t = 3.4007, df = 512.07, p-value = 0.0007245
...
#3 year -0.0801098 p-value < 2.2e-16

#t test
# low <- aggregate(sentiment~userid, weibo_2016_c_recent_l,mean)
# high <- aggregate(sentiment~userid, weibo_2016_c_recent_h,mean)
# 
# t.test(low$sentiment,high$sentiment, var.equal=F, paired=FALSE)
# 

####positive and negative valence in 3 yrs year
sub_360 <- read.csv("sub_3year.csv", header = T, fill=TRUE,row.names=NULL)
weibo_2016<- merge(all_h, sub_360, by.x="userid", by.y="userid", all.y=TRUE)
weibo_2016 <- weibo_2016[!duplicated(weibo_2016),]
...
multiplot(pos.valence.plot,neg.valence.plot,pos.valence.plot_3,neg.valence.plot_3, cols = 2)

t.test(pos.l$sentiment, pos.h$sentiment)



t.test(all_count$day.pos.aver_l[1:1095],all_count$day.pos.aver_h[1:1095], var.equal=F, paired=FALSE)
#t = -0.61565, df = 1383.8, p-value = 0.5382
...
t.test(all_count2$day.neg.aver_l[1:1095],all_count2$day.neg.aver_h[1:1095], var.equal=F, paired=FALSE)
#t = 0.61859, df = 1444.9, p-value = 0.5363
t.test(all_count2$day.neg.aver_l[1:365],all_count2$day.neg.aver_h[1:365], var.equal=F, paired=FALSE)
#t = 1.809, df = 516.73, p-value = 0.07103


var.test(all_count$day.aver_l[1:1095],all_count$day.aver_h[1:1095], var.equal=F, paired=FALSE)


# data:  pos.l$sentiment and pos.h$sentiment
